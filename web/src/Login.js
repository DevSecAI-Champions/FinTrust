  ...
  return (
    <div className="card">
      ...
      <div className="xss-demo">
        <label htmlFor="xss-input">Display name (XSS demo)</label>
        <p className="xss-notice">Training only: this field renders input as HTML.</p>
        <input
          id="xss-input"
          type="text"
          value={userInput}
          onChange={(e) => setUserInput(e.target.value)}
          placeholder="e.g. Your name or script payload"
        />
        <div className="output" dangerouslySetInnerHTML={{ __html: userInput || '(empty)' }} />
      </div>
    </div>
  );
}
